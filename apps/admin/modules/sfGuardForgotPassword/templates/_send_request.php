<?php use_helper('I18N') ?>
<?php echo __('Dear %first_name%', array('%first_name%' => $user->getFirstName()), 'sf_guard') ?>,<br/><br/>

<?php echo __('This e-mail is being sent because you requested information on how to reset your password on the GSA Website.', null, 'sf_guard') ?><br/><br/>
